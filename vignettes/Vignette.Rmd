...
```{r, eval=FALSE}
system.file("extdata", "TestData.txt", package = "genecounteR")
gene.counts <- read.table(system.file("extdata", "TestData.txt", package = "genecounteR"), sep="\t", header=T, row.names=1, check.names=F)
